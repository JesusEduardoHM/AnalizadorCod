...
public class Errores extends JFrame {
	...
	public Errores() {
		...
		label.setIcon(new ImageIcon(Errores.class.getResource("/Img/Fondo.jpg")));
		label.setBounds(0, 0, 450, 410);
