...
public class Generador 
{
	...
	private String reservadas[]={ "int","float","char"}; 	
	private char simbolos[]={ '+','-','*','/','=','(',')',',',';'};	
	private String CodSalida="", Tipo="";
	boolean id =false;
		...
		else
		{
			...
			else
			{
				...
				else
				{
							...
							else
							{
								...
								else
								{
									...
									else
									{
										...
										asig=false;
										this.CodSalida+=idr+" ";
									// Nueva lógica para las operaciones
                                                                                                                                                                            if (leer) {
                                                                                                                                                                                this.CodSalida += lexema + " ); \n";
                                                                                                                                                                                leer = false;
                                                                                                                                                                            } else {
                                                                                                                                                                                if (i) {
                                                                                                                                                                                    ...
                                                                                                                                                                                    // Aquí se realiza la evaluación de expresiones
                                                                                                                                                                                    this.ProcesarExpresion(lexema);
                                                                                                                                                                                }
                                                                                                                                                                            }
                                                                                                                                                                        }
                                                                                                                                                                    }
                  ...
                  private void ProcesarExpresion(String lexema) {
                        if (pare) {
                            if (lexema.equals("+") || lexema.equals("-")) {
                                pareidnpr.add(lexema);
                                if (paremuldiv) {
                            ...
                            // Si no estamos dentro de paréntesis, procesar normalmente
                            if (lexema.equals("(")) {
                                pare = true;
                            } else {
                                // Resto del código de ProcesarExpresion si no estamos dentro de paréntesis
                                if (lexema.equals("+") || lexema.equals("-")) {
                                    idnpr.add(lexema);
                                    if (muldiv) {
                                        sumrespr.add(0);
